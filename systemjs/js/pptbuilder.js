...
// Define slide masters with updated styling (no extra chart grid background)
...
// Helper to add bullet points with adjusted font size and spacing
function addBullets(slide, bullets, startY, x = 0.5, width = 9, fontSize = 14) {
    bullets.forEach((text, i) => {
        slide.addText(text, {
            x, y: startY + (i * 0.6), // increased height to make bullet points visible
            w: width, h: 0.6,
...
// Create a two-column slide with adjusted fonts
...
// Create a chart slide with reduced dimensions and removed gridlines
        ...
        if (chartType === 'bar' || chartType === 'column') {
            ...
            slide.addChart(
                ...
                chartSeries,
                {
                    ...
                    showValue: true,
                    // Remove gridlines by setting style to 'none'
...
// Fallback: Render chart data as text if chart creation fails
...
// Create a default slide for unspecified slide types
